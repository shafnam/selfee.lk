<nav class="navbar navbar-expand-lg navbar-dark bg-dark main-menu">
    <div class="container">
        ...
        <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
            <img src="<?php echo e(asset('web-photos/selfee-logo.png')); ?>" class="img-fluid com-img" width="150" alt="Selfee.lk">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            ...
            <ul class="nav navbar-nav navbar-right menu-bar">
                <li class="nav-item add-post">
                    <a class="nav-link" href="<?php echo e(url('ads/post-ad')); ?>" style="color: #fff;">Post Your Ad</a>
                </li>
            </ul>
