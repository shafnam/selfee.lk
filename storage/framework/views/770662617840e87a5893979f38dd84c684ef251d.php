...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row" style="background: white;">
        ...
        <div class="col-md-2 cat-box">
            <div class="card">
                <div class="card-body">
                    <img src="/storage/images/<?php echo e($itemServiceCategory->icon); ?>" class="img-fluid com-img" width="36" alt="<?php echo e($itemServiceCategory->name); ?>">
                    <a href="/ads/category/<?php echo e($itemServiceCategory->slug); ?>"><?php echo e($itemServiceCategory->name); ?></a>
                    <?php $ad_count = \App\Category::getCategoryAdsCount($itemServiceCategory->id); ?>
                    <p> (<?php echo $ad_count; ?>) </p>
                </div> 
            </div>
        </div>
