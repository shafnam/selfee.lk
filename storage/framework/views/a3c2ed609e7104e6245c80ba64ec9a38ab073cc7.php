    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="<?php echo e(route('administrator.ads.reject.post',[$ad->id])); ?>" method="post">
                    ...
                    <div class="col-md-8 col-sm-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input name="name" id="ad_name" class="form-control" required value="<?php echo e($ad->title); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8 col-sm-12">
