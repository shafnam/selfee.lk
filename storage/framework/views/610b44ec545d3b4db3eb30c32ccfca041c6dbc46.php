...
<body>
    <div id="app">
        ...
        <div class="container-fluid b-section inner-page" <?php if(Request::is('/')): ?> style="border-top: 2px solid #e07f0a;"<?php endif; ?>>
            <div class="container" <?php if(Request::is('/')): ?> style="margin-top: 60px; box-shadow: 0 3px 4px 1px #d5e1e6; border-radius: 5px;"<?php endif; ?>>
