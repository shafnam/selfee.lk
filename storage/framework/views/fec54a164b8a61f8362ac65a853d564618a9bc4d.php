            ...
            <div class="row">
                <div class="col-md-12">
                    <p>
                        ...
                        <!-- location -->
                        <a href="<?php echo e(url('ads/location/'.$loc_parent_details->slug )); ?>/<?php echo e($ad->locations->slug); ?>"><?php echo e($ad->locations->name); ?></a> <i class="fa fa-long-arrow-right" aria-hidden="true"></i>
                        <!-- get category parent -->
                        ...
                        <!-- category -->
                        <a href="<?php echo e(url('ads/category/'.$cat_parent_details->slug )); ?>/<?php echo e($ad->categories->slug); ?>"><?php echo e($ad->categories->name); ?></a> <i class="fa fa-long-arrow-right" aria-hidden="true"></i>
            ...
            <div class="row adz-info">
                <div class="col-md-12">
                    ...
                    <p><?php 
                        ...
                        by <?php echo e($ad->users->name); ?> <i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo e(date('Y M d g:i a', strtotime($ad->created_at))); ?> <i class="fa fa-map-marker" aria-hidden="true"></i> Colombo</p>
                </div>
            </div>
                        ...
                        <div class="clearfix" style="max-width:474px;">
                            <ul id="image-gallery" class="gallery list-unstyled cS-hidden">
                                <?php $__currentLoopData = $ad->ad_photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad_photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li data-thumb="/storage/ad-photos/<?php echo e($ad_photo->title); ?>">
            ...
            <div class="row adz-contact">
                <div class="col-md-12">
                    ...
                    <?php $__currentLoopData = $ad->user_phones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user_phone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <p><i class="fa fa-phone" aria-hidden="true"></i> <?php echo e($user_phone->mobile_number); ?></p>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
        </div>
    ...
    <div class="row similar-adz">
        ...
        <div class="col-md-12 sa-right">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="card">
                        <img class="card-img-top" src="/storage/ad-photos/<?php echo e($relatedAd->ad_photos->first()->title); ?>" alt="Card image cap">
                        <div class="card-body">
