    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="<?php echo e(route('administrator.category.edit.post',[$category->id])); ?>" method="post">
                    ...
                    <div class="col-md-8 col-sm-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input name="name" id="category_name" class="form-control" required value="<?php echo e($category->name); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8 col-sm-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input name="slug" id="category_slug" class="form-control" required value="<?php echo e($category->slug); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8 col-sm-12">
