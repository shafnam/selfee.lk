...
@section('content')
    ...
    <div class="row white-bg">
        ...
        <div class="col-md-12 add-mid">
            <div class="row">
                ...
                <div class="col-md-6 add-mid-left">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <img src="{{asset('web-photos/icon-money.png')}}" class="" alt="Responsive image">
                ...
                <div class="col-md-6 add-mid-right">
                    <div class="card">
                        <div class="card-body">
                            <img src="{{ asset('web-photos/icon-search.png') }}" class="" alt="Responsive image">
        ...
        <!--<div class="col-md-12 add-bot">
            <hr>
            <div class="allow-box">
                <img src="{{ asset('web-photos/icon-tag.png') }}" class="" alt="Responsive image">
