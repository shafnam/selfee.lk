    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="{{ route('administrator.location.edit.post',[$location->id]) }}" method="post">
                    ...
                    <div class="col-md-8 col-sm-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input name="name" id="location_name" class="form-control" required value="{{ $location->name }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8 col-sm-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input name="slug" id="location_slug" class="form-control" required value="{{ $location->slug }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8 col-sm-12">
