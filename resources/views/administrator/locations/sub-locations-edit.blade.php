    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="{{ route('administrator.sub-location.edit.post',[$sub_location->id]) }}" method="post">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" id="location_id" name="location_id" value="{{ $sub_location->id }}">
                            ...
                            <div class="form-group">
                                <select class="form-control" name="parent_location" id="parent_location" required>
                                    ...
                                    @foreach($all_locations as $al)
                                        @if($al->id == $sub_location->parent_id)
                    ...
                    <div class="col-md-8 col-sm-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input name="name" id="location_name" class="form-control" required value="{{ $sub_location->name }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8 col-sm-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input name="slug" id="location_slug" class="form-control" required value="{{ $sub_location->slug }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8 col-sm-12">
